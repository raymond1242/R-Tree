#ifndef RNODO_H_INCLUDED
#define RNODO_H_INCLUDED
...
struct rNodo{
    ...
    void pickNext(rNodo<N>*n1,rNodo<N>*n2,vector<objeto*>&objetosAux){
        ...
        //cout<<(n1->ocupados<((float)N/2) &&n2->ocupados<((float)N/2) ) ;
